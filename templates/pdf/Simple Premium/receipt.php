<?php 
if(defined("WP_PLUGIN_DIR") && file_exists(WP_PLUGIN_DIR . "/woocommerce-pdf-invoices-packing-slips/templates/Simple Premium/invoice.php")){
	include_once WP_PLUGIN_DIR . "/woocommerce-pdf-invoices-packing-slips/templates/Simple Premium/invoice.php";
} else {
?>
