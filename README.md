...
* WooCommerce v. 3.2.6
* WooCommerce PDF Invoices & Packing Slips [Ewout Fernhout] v. 2.1.3
* WooCommerce PDF Invoice [RightPress] v. 2.1.6
* [WPML Multilingual CMS](https://wpml.org/) v. 3.8.4
* [WooCommerce Multilingual](https://wpml.org/) v. 4.2.7.1
...
![Nella pagina del checkout aggiunge la possibilità di scegliere fra Fattura o Ricevuta e di inserire un Codice Fiscale o Partita IVA](https://ps.w.org/woocommerce-pdf-invoices-italian-add-on/assets/screenshot-1.png)

### 2. Le stesse opzioni riportate nei dettagli dell'ordine, nell'indirizzo di fatturazione...
![Le stesse opzioni riportate nei dettagli dell'ordine, nell'indirizzo di fatturazione...](https://ps.w.org/woocommerce-pdf-invoices-italian-add-on/assets/screenshot-2.png)

### 3. ... e nella pagina dell'utente.
![... e nella pagina dell'utente.](https://ps.w.org/woocommerce-pdf-invoices-italian-add-on/assets/screenshot-3.png)
...
![Il codice Fiscale o la Partita IVA vengono riportate nei dati dell'indirizzo, e quindi anche nelle email o nel pdf di fattura o ricevuta](https://ps.w.org/woocommerce-pdf-invoices-italian-add-on/assets/screenshot-4.png)
